  ...
  return (
    <section className="bg-muted/60 py-16 sm:py-20">
      <div className="container-width">
        {/* Retrato à esquerda, texto e CTAs à direita — os botões fecham a
            coluna de texto em vez de ficarem soltos debaixo dos cartões. */}
        ...
        {/* Credenciais em linha, à largura toda */}
