    ...
    items: [
      {
        ...
        answer:
          'Cônjuges ou companheiros de portugueses podem solicitar a cidadania após 3 anos de casamento ou união de facto reconhecida. O pedido está sujeito à verificação de ligação efetiva à comunidade portuguesa — excepto quando o casamento/UF tiver mais de 6 anos ou existirem filhos comuns com nacionalidade portuguesa, casos em que a oposição não se aplica. Prazo actual (dados IRN abr/mai 2026): 50 a 54 meses. A união de facto deve ser reconhecida judicialmente em Portugal.',
      },
      {
