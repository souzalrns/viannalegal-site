  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          'Sim! Oferecemos uma análise inicial via WhatsApp onde avaliamos: sua elegibilidade para cidadania portuguesa, documentos que você já possui, estimativa de prazo e custos, e próximos passos recomendados. Agende sua consulta pelo WhatsApp +351 913 134 260.',
      },
    ],
  },
];
