...
export const allBlogPosts: BlogPost[] = [
{
    ...
    excerpt: 'Guia passo a passo actualizado com a Lei Orgânica 1/2026. Descubra quem tem direito, quais documentos reunir, prazos reais do IRN e quanto custa o processo de cidadania portuguesa.',
    date: '27 Jun 2026',
    readTime: '18 min',
    ...
    icon: Scale,
    featured: true,
    metaDescription: 'Como tirar cidadania portuguesa em 2026: quem tem direito, documentos, prazos IRN e custos. Guia actualizado com a Lei Orgânica 1/2026.',
    relatedSlugs: ["guia-completo-cidadania-portuguesa-2025", "cidadania-portuguesa-netos-guia-completo", "documentos-cidadania-portuguesa-checklist-completo"],
    content: `
...
- Prazo estimado: {{prazo_filhos_menores}} (filhos menores) / {{prazo_filhos_maiores}} (filhos maiores) — dados IRN abr/mai 2026
...
| Via | Prazo estimado |
|-----|---------------|
| Filhos menores | **{{prazo_filhos_menores}}** |
| Filhos maiores (inscrição) | **{{prazo_filhos_maiores}}** |
| Transcrição de casamento (registo em PT) | **{{prazo_transcricao}}** |
| Netos menores | **{{prazo_filhos_menores}}** |
...
| Via | Prazo estimado |
|-----|---------------|
| Naturalização CPLP/UE (7 anos) | **{{prazo_naturalizacao}}** |
| Naturalização outros países (10 anos) | **{{prazo_naturalizacao}}** |
...
**Fase 4 — Análise pelo IRN ({{prazo_netos_maiores}} (maiores) / {{prazo_filhos_menores}} (menores)):** O processo entra na fila da Conservatória dos Registos Centrais (CRC). Diligências podem surgir — têm prazo de resposta e precisam ser monitoradas.
...
| Análise pelo IRN | {{prazo_netos_maiores}} (maiores) / {{prazo_filhos_menores}} (menores) |
...
Processo simplificado, mais rápido. O pedido é feito pelos responsáveis legais. Não exige vínculo efetivo. **Prazo estimado: {{prazo_filhos_menores}}.**

### Filhos maiores (18 anos ou mais)
Trâmite regular, fila padrão do IRN. Direito idêntico ao do menor. **Prazo estimado: {{prazo_filhos_maiores}}.**
...
| Prazo total estimado | 7 anos + {{prazo_naturalizacao}} | {{prazo_netos_maiores}} |
...
Desconfie de quem promete prazos menores do que os praticados pelo IRN ({{prazo_netos_maiores}} para netos maiores). Esses prazos são determinados pela fila do IRN, não pela assessoria.
...
1. **Transcrição do casamento no IRN** — prazo estimado de {{prazo_transcricao}} (dados abr/mai 2026, ±5%)
2. **Pedido de cidadania** — prazo estimado de {{prazo_casamento}} de análise
...
O [IRN](https://irn.justica.gov.pt/nacionalidade-portuguesa) leva {{prazo_netos_maiores}} para analisar processos de netos maiores. Nesse período, os documentos originais estarão com prazo vencido — isso não é problema. A validade é exigida na **data do protocolo**, não durante a análise.
...
O [IRN](https://irn.justica.gov.pt/nacionalidade-portuguesa) trata processos de menores com prioridade. O prazo estimado é de **{{prazo_filhos_menores}}** — contra {{prazo_filhos_maiores}} para filhos maiores e {{prazo_netos_maiores}} para netos maiores (dados abr/mai 2026, ±5%).
...
**Meu filho tem 17 anos. Vale a pena correr para protocolar antes dos 18?** Definitivamente. A diferença entre {{prazo_filhos_menores}} (menor) e {{prazo_filhos_maiores}} (filho maior) justifica qualquer esforço.
...
A ressalva é que o processo muda: o processo de filho menor é mais simples e rápido. O processo de filho maior (18+ anos) tem prazos de análise de [{{prazo_filhos_maiores}}](https://irn.justica.gov.pt/nacionalidade-portuguesa) segundo dados do IRN de abr/mai 2026 (±5%). Em alguns casos, aguardar pode não ser a melhor estratégia.
...
A característica central da aquisição é que **os requisitos precisam ser mantidos durante o processo**. Se um casal se divorcia durante os {{prazo_casamento}} de análise do IRN, o direito de aquisição por casamento pode ser afetado. Se o residente perde seu título de residência, o mesmo pode ocorrer.
...
- Filhos menores: {{prazo_filhos_menores}}
- Filhos maiores: {{prazo_filhos_maiores}}
- Netos menores: {{prazo_filhos_menores}}
- Netos maiores: {{prazo_netos_maiores}}
- Casamento/UF: {{prazo_casamento}}
...
Os prazos do [IRN](https://irn.justica.gov.pt/nacionalidade-portuguesa) são iguais para todo o Brasil. Para netos maiores: {{prazo_netos_maiores}}; para filhos maiores: {{prazo_filhos_maiores}} (dados abr/mai 2026, ±5%). Veja o processo completo em nosso [guia completo de cidadania portuguesa](/blog/guia-completo-cidadania-portuguesa-2025).
...
Os prazos do [IRN](https://irn.justica.gov.pt/nacionalidade-portuguesa) são os mesmos para todo o Brasil. Para netos maiores: {{prazo_netos_maiores}}; para filhos maiores: {{prazo_filhos_maiores}} (dados abr/mai 2026, ±5%). Veja mais em [todas as formas de obter cidadania portuguesa](/blog/guia-definitivo-todas-as-formas-de-obter-cidadania-portuguesa-em-2026).
...
Os prazos do [IRN](https://irn.justica.gov.pt/nacionalidade-portuguesa) são os mesmos para todo o Brasil — {{prazo_netos_maiores}} para netos maiores; {{prazo_filhos_maiores}} para filhos maiores (dados abr/mai 2026, ±5%).
...
**Os prazos do IRN:** A posição na fila é a mesma. Para netos maiores: {{prazo_netos_maiores}}; para filhos maiores: {{prazo_filhos_maiores}} (dados abr/mai 2026, ±5%).
...
| Tipo | Prazo estimado |
|---|---|
| Filho menor | {{prazo_filhos_menores}} |
| Filho maior | {{prazo_filhos_maiores}} |
| Neto menor | {{prazo_filhos_menores}} |
| Neto maior | {{prazo_netos_maiores}} |

O prazo de netos maiores ({{prazo_netos_maiores}}) é menor do que o de filhos maiores ({{prazo_filhos_maiores}}) — reflexo do volume de cada tipo na fila.
...
**Moro em Portugal e sou neto de português. Qual processo é mais vantajoso?** Via de neto: {{prazo_netos_maiores}}, sem exigência de residência. Naturalização (se já tem 7 anos de residência): {{prazo_naturalizacao}} de análise, mas pressupõe 7 anos já cumpridos. A assessoria avalia qual é mais eficiente para cada situação.
...
Para casais que ainda não formalizaram o relacionamento, o casamento civil quase sempre é o caminho mais simples. A transcrição de um casamento civil no [IRN](https://irn.justica.gov.pt/nacionalidade-portuguesa) leva {{prazo_transcricao}} — muito menos do que o reconhecimento judicial de união de facto.
...
**Meu processo está "em análise" há 2 anos. É normal?** Para netos maiores, o prazo estimado é {{prazo_netos_maiores}}. Dois anos em análise está dentro da normalidade.
...
- Filhos maiores de português: **{{prazo_filhos_maiores}}** (±5%)
- Netos maiores de português: **{{prazo_netos_maiores}}** (±5%)
...
Os prazos do [IRN](https://irn.justica.gov.pt/nacionalidade-portuguesa) são os mesmos para todo o Brasil. Para netos maiores: {{prazo_netos_maiores}}; para filhos maiores: {{prazo_filhos_maiores}} (dados abr/mai 2026, ±5%). Veja [todas as formas de obter cidadania portuguesa](/blog/guia-definitivo-todas-as-formas-de-obter-cidadania-portuguesa-em-2026).
...
Filhos de pai ou mãe português(a), nascidos em qualquer lugar. Atribuição — o direito existe desde o nascimento, não prescreve. Pode ser feito do Brasil. Prazo no [IRN](https://irn.justica.gov.pt/nacionalidade-portuguesa): {{prazo_filhos_menores}} (menores) / {{prazo_filhos_maiores}} (maiores).

## Via 2: Descendência (netos de portugueses)

Netos de avô ou avó português(a), com comprovação de vínculo efetivo com a comunidade portuguesa. Atribuição sem prazo de caducidade. Pode ser feito do Brasil. Prazo: {{prazo_filhos_menores}} (menores) / {{prazo_netos_maiores}} (maiores).

## Via 3: Aquisição por casamento ou união de facto

Cônjuge de cidadão português, após 3 anos de casamento civil ou união de facto judicialmente reconhecida (sujeito a verificação de vínculo efetivo, salvo casamento/UF com mais de 6 anos, filhos comuns portugueses ou residência legal em Portugal). Pode ser feito do Brasil. Prazo: {{prazo_casamento}} (mais {{prazo_transcricao}} de transcrição prévia).

## Via 4: Naturalização por residência em Portugal

Estrangeiros com residência legal continuada. Para brasileiros e CPLP: **7 anos** (desde a Lei 1/2026). Não pode ser feito do Brasil. Prazo de análise: {{prazo_naturalizacao}}.
...
Pais estrangeiros com 5 anos de residência legal em Portugal (novo requisito — antes era 1 ano). Prazo: {{prazo_filhos_menores}}.
...
|---|---|
| Filhos menores de português | {{prazo_filhos_menores}} |
| Netos menores de português | {{prazo_filhos_menores}} |
| Transcrição de casamento | {{prazo_transcricao}} |
| Filhos maiores de português | {{prazo_filhos_maiores}} |
...
Processos de menores de 18 anos têm tramitação prioritária — {{prazo_filhos_menores}} vs. 40 a 56 meses para adultos. Se você tem filhos com direito à cidadania que ainda são menores, o processo deles é dramaticamente mais rápido. A partir dos 18 anos, passam para a fila geral. Vale protocolar antes da maioridade.

## Por que netos são mais rápidos do que filhos (adultos)

O prazo de netos maiores ({{prazo_netos_maiores}}) é menor do que o de filhos maiores ({{prazo_filhos_maiores}}). A razão é o volume — há muito mais processos de filhos na fila.

## Naturalização: mais rápida em análise, mais longa no total

O prazo de análise para naturalização ({{prazo_naturalizacao}}) é menor do que para netos — mas o processo total é muito mais longo: 7 anos de residência + {{prazo_naturalizacao}} de análise = cerca de 9 anos desde a chegada a Portugal.
...
**Meu processo tem 48 meses. Está além do prazo?** Para netos maiores, o estimado é {{prazo_netos_maiores}}. Com 48 meses, está além da estimativa mas dentro de variação plausível. Verifique se não há diligência pendente no [portal oficial](https://nacionalidade.justica.gov.pt).
...
Os prazos do [IRN](https://irn.justica.gov.pt/nacionalidade-portuguesa) são iguais para todo o Brasil. Para netos maiores: {{prazo_netos_maiores}}; para filhos maiores: {{prazo_filhos_maiores}} (dados abr/mai 2026, ±5%). Para processos com documentação do período colonial, a pesquisa genealógica pode ser mais complexa. Veja mais sobre documentos difíceis em [cidadania para quem não tem documentos do avô](/blog/cidadania-portuguesa-para-quem-tem-documentos-perdidos).
...
Os prazos do [IRN](https://irn.justica.gov.pt/nacionalidade-portuguesa) são os mesmos para todo o Brasil. Para netos maiores: {{prazo_netos_maiores}}; para filhos maiores: {{prazo_filhos_maiores}} (dados abr/mai 2026, ±5%). Consulte o [checklist de documentos para netos](/blog/checklist-completa-de-documentos-para-netos-de-portugueses) para saber o que reunir.
...
**Verdade:** Há diferenças significativas. Filhos não precisam comprovar vínculo efetivo; netos sim. O prazo de análise para netos maiores ({{prazo_netos_maiores}}) é diferente do de filhos maiores ({{prazo_filhos_maiores}}). A cadeia documental é mais longa para netos. Veja mais em [filho vs. neto: diferenças no processo](/blog/filho-vs-neto-diferencas-no-processo-de-cidadania-portuguesa).
...
Esta é a causa mais comum — e a mais benigna. O [IRN](https://irn.justica.gov.pt/nacionalidade-portuguesa) tem mais de 700 mil processos pendentes. O prazo estimado para netos maiores é de {{prazo_netos_maiores}}; para filhos maiores, {{prazo_filhos_maiores}} (dados abr/mai 2026, ±5%). Um processo de 2021 que ainda não tem decisão em 2025 pode estar exatamente onde deveria estar: na fila, aguardando a vez.
...
Sim — dependendo do tipo de processo. Processos de netos maiores têm prazo estimado de {{prazo_netos_maiores}}. Um processo de 2021 que ainda não foi decidido em 2025–2026 pode estar na margem normal da fila.
...
- Filhos ou netos menores: {{prazo_filhos_menores}}
- Netos maiores: {{prazo_netos_maiores}}
- Filhos maiores: {{prazo_filhos_maiores}}
- Casamento: {{prazo_casamento}} (mais {{prazo_transcricao}} de transcrição prévia)
- Naturalização (brasileiros): {{prazo_naturalizacao}} de análise, após 7 anos de residência em Portugal
...
**Filhos menores:** {{prazo_filhos_menores}} de análise. Vale a pena protocolar urgentemente antes dos 18 anos.
**Filhos maiores:** Processo individual, {{prazo_filhos_maiores}}.
